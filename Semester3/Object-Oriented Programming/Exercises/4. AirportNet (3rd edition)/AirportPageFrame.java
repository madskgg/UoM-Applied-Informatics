...
public class AirportPageFrame extends JFrame {
    ...
    class findButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            // Κλήση μεθόδου για τη δημιουργία του text file
            createTextFile(airportA.getCity(), airportB.getCity(), airportA.getCountry(), airportA.getName(), airportA.getCode(), directFlightsText, indirectFlightsText);
        }  
        
        // Μέθοδος για τη δημιουργία του text file
        private void createTextFile(String departureCity, String arrivalCity, String departureCountry, String departureAirport, String departureAirportCode, String directFlights, String indirectFlights) {

            try {
            	String fileName = departureCity + "To" + arrivalCity + ".txt";
            	FileWriter writer = new FileWriter(fileName);
            	// Εγγραφή δεδομένων στο text file
            	writer.write("CITY: " + departureCity + ", " + departureCountry + "\n");
            	writer.write("Airport: " + departureAirport + " (" + departureAirportCode + ")\n");
            	writer.write(System.lineSeparator());
            	writer.write("DESTINATION: " + arrivalCity + "\n");
            	writer.write(System.lineSeparator());
                writer.write("DIRECT FLIGHT DETAILS\n");
                writer.write(directFlights);
                writer.write(System.lineSeparator());
                writer.write("INDIRECT FLIGHTS through...\n");
                writer.write(indirectFlights);
                
                // Κλείσιμο αρχείου
                writer.close();
                
                // Εμφάνιση μηνύματος σε περίπτωση επιτυχίας δημιουργίας του αρχείου
                JOptionPane.showMessageDialog(null, "Text file created successfully: " + fileName, "Message", JOptionPane.INFORMATION_MESSAGE);
            } catch (IOException ex) {
            	// Εμφάνιση μηνύματος σε περίπτωση αποτυχίας δημιουργίας του αρχείου
                JOptionPane.showMessageDialog(null, "Error creating text file: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
